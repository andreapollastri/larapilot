...
Personas are lenses. The roster is `.larapilot/runtime-core-personas.md`. Chat uses `icon + name`. Brevity is **Output Economy** in `.larapilot/runtime-core-economy.md`: the implement status line is one line per task, and the spec handoff is 6 lines. Sub-agents are readonly and never run under `effort: ECO`.
