...
| `.larapilot/runtime-dev-docs.md`   | Developer domain docs under `.larapilot/docs/devs/` — one file per domain/entity/feature, functional flow + technical design + architectural choices + key decisions, English only, **always on** | `implement`, `review`, `ship`, `adopt`, `bug`, `autopilot` |
